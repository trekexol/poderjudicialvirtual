...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('theme-home/assets/favicon.ico')}}" />
        <!-- Bootstrap icons-->
    ...
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" style="background-color: rgb(255, 255, 255);" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand fw-bold" href="{{ route('welcome')}}"><img src="{{asset('images/couriertool-logo.png')}}" style="width: 140px;height:60px;" alt="" /></a>
