...
class PackageSearchController extends Controller
{
    ...
    public function validation($request){
        ...
        if(isset($request->id_agency) && isset($request->id_wharehouse) && $shipping_type != "Todos"){
            ...
            'packages.description','packages.starting_weight','packages.final_weight','packages.arrival_date','wharehouses.code as wharehouse_code','packages.volume','packages.cubic_foot','packages.date_payment','packages.instruction','agencies.name as agency_name',
            ...
            ->groupBy('packages.id','packages.id_agent_shipper','packages.id_agent_vendor',
                    'packages.tracking','packages.status','clients.casillero','clients.firstname','clients.firstlastname','clients.type_cedula','clients.id_agency','clients.cedula',
                    'packages.description','packages.starting_weight','packages.final_weight','packages.arrival_date','wharehouses.code','packages.volume','packages.cubic_foot','packages.date_payment','packages.instruction','agencies.name')
            ->get();
