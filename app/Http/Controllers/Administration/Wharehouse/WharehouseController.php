...
namespace App\Http\Controllers\Administration\Wharehouse;
...
class WharehouseController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.administrations.wharehouses.index',compact('wharehouses'));
    }
    ...
    public function create(){
        ...
        return view('admin.administrations.wharehouses.create',compact('agencies'));
    }
    ...
    public function store(Request $request){
     ...
     public function edit($id){
         ...
         return view('admin.administrations.agencies.edit',compact('wharehouse'));
     }
